...
FULL_YOLO_BACKEND_PATH  = "potholes/full_yolo_backend.h5"   # should be hosted on a server
TINY_YOLO_BACKEND_PATH  = "potholes/tiny_yolo_backend.h5"   # should be hosted on a server
SQUEEZENET_BACKEND_PATH = "potholes/squeezenet_backend.h5"  # should be hosted on a server
MOBILENET_BACKEND_PATH  = "potholes/mobilenet_backend.h5"   # should be hosted on a server
INCEPTION3_BACKEND_PATH = "potholes/inception_backend.h5"   # should be hosted on a server
VGG16_BACKEND_PATH      = "potholes/vgg16_backend.h5"       # should be hosted on a server
RESNET50_BACKEND_PATH   = "potholes/resnet50_backend.h5"    # should be hosted on a server
